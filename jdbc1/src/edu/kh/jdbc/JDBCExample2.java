...
public class JDBCExample2 {
	...
	public static void main(String[] args) {
		...
		Statement stmt = null; // SQL 수해으 결과 반환용 객체
		...
		try {
			...
			String dbName = ":XE"; // DBMS 이름 (XE == eXperss Edition)

			// jdbc:oracle:thin:@localhost:1521:XE

			String userName = "kh_hyg"; // 사용자 계정명
			...
			// executeQuery() : SELEXT 실해으 ResultSet 반환
			// ececuteUpdate() : DML 실행, 결과 행의 갯수 반환(int)
			rs = stmt.executeQuery(sql);

			// 6. 조회 결과가 담겨있는 ResultSet을
			// 1행씩 접근해 각 행에 작성된 컬럼값 얻어오가ㅣ
